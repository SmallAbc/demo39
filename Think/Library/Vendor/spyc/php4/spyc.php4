<?php
/**
   * Spyc -- A Simple Think YAML Class
   * @version 0.4.5
...
/**
   * The Simple Think YAML Class.
   *
   * This class can be used to read a YAML file and convert its contents
   * into a Think array.  It currently supports a very limited subsection of
   * the YAML spec.
   *
   * Usage:
   * <code>
 ...
 */
  ...
  /**
     * Load YAML into a Think array statically
     *
     * The load method, when supplied with a YAML stream (string or file),
     * will do its best to convert YAML in a file into a Think array.  Pretty
     * simple.
     *  Usage:
     *  <code>
  ...
  /**
     * Load a string of YAML into a Think array statically
     *
     * The load method, when supplied with a YAML string, will do its best 
     * to convert YAML in a string into a Think array.  Pretty simple.
     *
  ...
  /**
     * Dump YAML from Think array statically
     *
