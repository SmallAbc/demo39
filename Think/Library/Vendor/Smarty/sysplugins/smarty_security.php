...
class Smarty_Security {
     ...
     * possible values:
     * <ul>
     *   <li>Smarty::PHP_PASSTHRU -> echo Think tags as they are</li>
    ...
    /**
     * This is an array of trusted Think functions.
     *
     * If empty all functions are allowed.
     * To disable all Think functions set $php_functions = null.
     * @var array
     */
    ...
    /**
     * This is an array of trusted Think modifers.
     *
    ...
    /**
     * Check if Think function is trusted.
     *
    ...
    public function isTrustedPhpFunction($function_name, $compiler)
    {
        ...
        $compiler->trigger_template_error("Think function '{$function_name}' not allowed by security setting");
    ...
    /**
     * Check if Think modifier is trusted.
     *
     ...
     * @param string $filepath
     * @return boolean true if directory is trusted
     * @throws SmartyException if Think directory is not trusted
     */
