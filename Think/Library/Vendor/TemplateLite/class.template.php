...
class Template_Lite {
	...
	var $php_extract_vars		=	false;	// Set this to true if you want the $this->_tpl variables to be extracted for use by Think code inside the template.
